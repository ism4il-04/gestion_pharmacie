...
namespace GestionPharmacie
{
    public partial class Accueil : Form
    {
        ...
        public Accueil()
        {
            ...
            // Lier l'événement de sélection de l'alerte (double-clic pour éviter les doublons)
            listBoxAlertes.DoubleClick += ListBoxAlertes_DoubleClick;
        ...
        private void ListBoxAlertes_DoubleClick(object sender, EventArgs e)
        {
            if (listBoxAlertes.SelectedIndex != -1)
            {
                string selectedAlert = listBoxAlertes.SelectedItem.ToString();
        ...
        private void ChargerStatistiques()
        {
            try
            {
                ...
                // Total médicaments (seulement actifs)
                string sqlTotal = "SELECT COUNT(*) FROM medicament WHERE est_actif = 1";
        ...
        private void archiverMedicamentToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ArchiverMedicament f = new ArchiverMedicament();
            var result = f.ShowDialog();
            if (result == DialogResult.OK)
            {
